        ...
        compact_entries.append(
            {
                ...
                "status": e.get("status"),
                "evaluation_stage": e.get("evaluation_stage"),
                "promoted_to_formal": bool(e.get("promoted_to_formal")),
                "total_runs": e.get("total_runs"),
                "total_runs_expected": e.get("total_runs_expected"),
                "total_runs_completed": e.get("total_runs_completed"),
                "metrics": e.get("metrics", {}),
                "evaluation_protocol": e.get("evaluation_protocol", {}),
